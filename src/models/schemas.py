...
class MenuRemove(RemoveModel):
    class Config:
        schema_extra = {
            "example": {"status": True, "message": "The menu has been deleted"}
        }


class MenuError(ModelError):
    class Config:
        schema_extra = {"example": {"detail": "menu not found"}}
...
class SubMenuRemove(RemoveModel):
    class Config:
        schema_extra = {
            "example": {"status": True, "message": "The submenu has been deleted"}
        }


class SubMenuError(ModelError):
    class Config:
        schema_extra = {"example": {"detail": "submenu not found"}}
...
class DishRemove(RemoveModel):
    class Config:
        schema_extra = {
            "example": {"status": True, "message": "The dish has been deleted"}
        }


class DishError(ModelError):
    class Config:
        schema_extra = {"example": {"detail": "dish not found"}}
